...
<form action="submit.php" method="post">
    <input type="hidden" name="database" value="audi"/>
    <label for="refill_date">Date: <input type="date" name="refill_date" value="<?php echo date('Y-m-d'); ?>"></label>
    <br><br>
    <label for="mileage">Mileage: <input type="number" name="mileage" min="250000" max="500000" value="25"></label>
    <br><br>
    <label for="cost">Cost: <input type="number" name="cost" min="1" max="50000" step="any"></label>
    <br><br>
    <label for="litre">Litre: <input type="number" name="litre" min="0" max="120" step="any"></label>
    <br><br>
