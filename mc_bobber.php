...
<form action="submit.php" method="post">
    <input type="hidden" name="database" value="mc_bobber"/>
    <label for="refill_date">Date: <input type="date" name="refill_date" value="<?php echo date('Y-m-d'); ?>"></label>
    <br><br>
    <label for="mileage">Mileage: <input type="number" name="mileage" min="190000" max="500000"></label>
    <br><br>
    <label for="cost">Cost: <input type="number" name="cost" min="1" max="50000" step="any"></label>
    <br><br>
    <label for="litre">Litre: <input type="number" name="litre" min="1" max="30" step="any"></label>
    <br><br>
...
<br>
<img src="images/signal-2021-10-09-140539.jpeg" alt="MC Bobber" style="max-width:80%;height:auto;"/>
